...
public class MainTest {
	...
	public static void main(String[] args) {
		...
		*/
		...
		/*
		FMatrix mm = new FMatrix(4);
		mm.set(0, 1, new Float(3));
		mm.set(0, 2, new Float(5));
		mm.set(0, 3, new Float(8));
		mm.set(1, 0, new Float(1));
		mm.set(1, 2, new Float(2));
		mm.set(3, 1, new Float(3));
		...
		*/
		...
		List<Float> z = translate(new float[] {new Float(0.25), new Float(0.25), new Float(0.25), new Float(0.25)}); 
